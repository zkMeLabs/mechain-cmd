...
Examples:
# create object and upload file to storage provider, the corresponding object is mechain-object
$ mechain-cmd object put file.txt mechain://mechain-bucket/mechain-object,
# upload the files inside the folders
$ mechain-cmd object put --tags='[{"key":"key1","value":"value1"},{"key":"key2","value":"value2"}]' --recursive folderName mechain://bucket-name`,
		Flags: []cli.Flag{
			&cli.StringFlag{
...
$ mechain-cmd object get mechain://mechain-bucket/mechain-object  file.txt `,
		Flags: []cli.Flag{
			&cli.Int64Flag{
...
Examples:
$ mechain-cmd object cancel  mechain://mechain-bucket/mechain-object`,
	}
}
...
Examples:
$ mechain-cmd object ls mechain://mechain-bucket`,
		Flags: []cli.Flag{
			&cli.BoolFlag{
				Name:  recursiveFlag,
				Value: false,
...
Examples:
update visibility of the mechain-object
$ mechain-cmd object update --visibility=public-read  mechain://mechain-bucket/mechain-object`,
		Flags: []cli.Flag{
			&cli.GenericFlag{
				Name: visibilityFlag,
				Value: &CmdEnumValue{
...
Examples:
$ mechain-cmd object get-progress mechain://mechain-bucket/mechain-object`,
	}
}
...
Examples:
$ mechain-cmd object setTag --tags='[{"key":"key1","value":"value1"},{"key":"key2","value":"value2"}]' mechain://mechain-bucket/mechain-object`,
