...
replace (
	...
	github.com/bnb-chain/greenfield-common/go => github.com/zkMeLabs/mechain-common/go v0.0.0-20240529091431-125d8c2879ba
	github.com/bnb-chain/greenfield-go-sdk => ../greenfield-go-sdk
